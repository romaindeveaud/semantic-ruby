...
Des réponses ``standard'' sont livrées sous forme de liste: 
...
Ce corpus n'étant pas initiallement prévu pour vérifier l'expérience d'étiquetage de questions tel que prévu dans le cadre de notre algorithme, nous avons procédé à son enrichissement.
...
Ainsi, dans l'exemple précitée, nous complétons la description de la question par plusieurs étiquettes de classes, à savoir que l'entité source est une personne, et que la réponse cible  est un nom d'organisation (celui du groupe musical), et d'éditeur de disque: 
...
%%% Si il y a le second corpus, il faut le décrire à son tour ici avec sa source - le site web -
...
\par Les résultats de l'attributions de catégories aux 107 phrases du corpus étiqueté sont présentés dans le tableau 1. 
...
\begin{table}[htbp]
    \begin{center}
        \begin{tabular}{|p{12cm}|l|}
            ...
            \hline
            Mots-clés extraits pour une recherche par similarité cosinus & \textbf{70.37\%} \\
            \hline
            Entités nommées extraites pour une recherche de type question-réponse (compacité) & \textbf{56.86\%} \\
            \hline
