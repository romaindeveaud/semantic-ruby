...
#define HAVE_CONST_DB_CACHED_COUNTS 1
...
#define HAVE_CONST_DB_MPOOL_CLEAN 1
...
#define HAVE_CONST_DB_RECORDCOUNT 1
...
#define HAVE_CONST_DB_REP_LOGSONLY 1
...
#define HAVE_CONST_DB_REP_OUTDATED 1
...
#define HAVE_CONST_DB_VERB_CHKPOINT 1
...
#define HAVE_ST_DB_ENV_GET_REP_LIMIT 1
#define HAVE_ST_DB_ENV_GET_SHM_KEY 1
#define HAVE_ST_DB_ENV_GET_TAS_SPINS 1
...
#define HAVE_ST_DB_ENV_SET_REP_TRANSPORT 1
#define HAVE_ST_DB_ENV_SET_TIMEOUT 1
#define HAVE_ST_DB_ENV_SET_ENCRYPT 1
#define HAVE_ST_DB_ENV_SET_REP_LIMIT 1
...
#define HAVE_ST_DB_ENV_SET_TAS_SPINS 1
...
#define HAVE_ST_DB_ENV_SET_LK_MAX 1
...
#define HAVE_DB_ENV_REP_ELECT_5 1
...
#define HAVE_ST_DB_LOCK_STAT_ST_NNOWAITS 1
#define HAVE_ST_DB_LOCK_STAT_ST_NCONFLICTS 1
...
#define HAVE_CONST_DB_DSYNC_LOG 0
#define HAVE_CONST_DB_EVENT_PANIC 0
#define HAVE_CONST_DB_EVENT_REP_CLIENT 0
#define HAVE_CONST_DB_EVENT_REP_ELECTED 0
#define HAVE_CONST_DB_EVENT_REP_MASTER 0
#define HAVE_CONST_DB_EVENT_REP_NEWMASTER 0
#define HAVE_CONST_DB_EVENT_REP_PERM_FAILED 0
#define HAVE_CONST_DB_EVENT_REP_STARTUPDONE 0
#define HAVE_CONST_DB_EVENT_WRITE_FAILED 0
#define HAVE_CONST_DB_FIXEDLEN 0
#define HAVE_CONST_DB_HOME 0
#define HAVE_CONST_DB_IGNORE_LEASE 0
...
#define HAVE_CONST_DB_LOG_INMEMORY 0
#define HAVE_CONST_DB_LOG_IN_MEMORY 0
#define HAVE_CONST_DB_LOG_ZERO 0
#define HAVE_CONST_DB_MPOOL_PRIVATE 0
#define HAVE_CONST_DB_MULTIVERSION 0
#define HAVE_CONST_DB_MUTEX_PROCESS_ONLY 0
#define HAVE_CONST_DB_PAD 0
#define HAVE_CONST_DB_PREV_DUP 0
#define HAVE_CONST_DB_READ_COMMITTED 0
#define HAVE_CONST_DB_READ_UNCOMMITTED 0
#define HAVE_CONST_DB_REPFLAGS_MASK 0
#define HAVE_CONST_DB_REPMGR_ACKS_ALL 0
#define HAVE_CONST_DB_REPMGR_ACKS_ALL_PEERS 0
#define HAVE_CONST_DB_REPMGR_ACKS_NONE 0
#define HAVE_CONST_DB_REPMGR_ACKS_ONE 0
#define HAVE_CONST_DB_REPMGR_ACKS_ONE_PEER 0
#define HAVE_CONST_DB_REPMGR_ACKS_QUORUM 0
#define HAVE_CONST_DB_REPMGR_CONNECTED 0
#define HAVE_CONST_DB_REPMGR_DISCONNECTED 0
#define HAVE_CONST_DB_REPMGR_PEER 0
#define HAVE_CONST_DB_REP_ACK_TIMEOUT 0
#define HAVE_CONST_DB_REP_ANYWHERE 0
#define HAVE_CONST_DB_REP_BULKOVF 0
#define HAVE_CONST_DB_REP_CHECKPOINT_DELAY 0
#define HAVE_CONST_DB_REP_CONF_BULK 0
#define HAVE_CONST_DB_REP_CONF_DELAYCLIENT 0
#define HAVE_CONST_DB_REP_CONF_NOAUTOINIT 0
#define HAVE_CONST_DB_REP_CONF_NOWAIT 0
#define HAVE_CONST_DB_REP_CONNECTION_RETRY 0
#define HAVE_CONST_DB_REP_DEFAULT_PRIORITY 0
#define HAVE_CONST_DB_REP_EGENCHG 0
#define HAVE_CONST_DB_REP_ELECTION 0
#define HAVE_CONST_DB_REP_ELECTION_RETRY 0
#define HAVE_CONST_DB_REP_ELECTION_TIMEOUT 0
#define HAVE_CONST_DB_REP_FULL_ELECTION 0
#define HAVE_CONST_DB_REP_FULL_ELECTION_TIMEOUT 0
#define HAVE_CONST_DB_REP_IGNORE 0
#define HAVE_CONST_DB_REP_JOIN_FAILURE 0
#define HAVE_CONST_DB_REP_LEASE_EXPIRED 0
#define HAVE_CONST_DB_REP_LEASE_TIMEOUT 0
#define HAVE_CONST_DB_REP_LOCKOUT 0
#define HAVE_CONST_DB_REP_LOGREADY 0
#define HAVE_CONST_DB_REP_PAGEDONE 0
#define HAVE_CONST_DB_REP_REREQUEST 0
#define HAVE_CONST_DB_STAT_ALL 0
#define HAVE_CONST_DB_STAT_SUBSYSTEM 0
#define HAVE_CONST_DB_TXN_SNAPSHOT 0
...
#define HAVE_TYPE_DB_SEQUENCE 0
#define HAVE_TYPE_DB_COMPACT 0
#define HAVE_ST_DB_HASH_STAT_HASH_NRECS 0
#define HAVE_ST_DB_HASH_STAT_HASH_NELEM 0
#define HAVE_ST_DB_HASH_STAT_HASH_PAGECNT 0
#define HAVE_ST_DB_QUEUE_STAT_QS_NRECS 0
#define HAVE_ST_DB_QUEUE_STAT_QS_START 0
#define HAVE_ST_DB_REP_STAT_ST_BULK_FILLS 0
#define HAVE_ST_DB_REP_STAT_ST_BULK_OVERFLOWS 0
#define HAVE_ST_DB_REP_STAT_ST_BULK_RECORDS 0
#define HAVE_ST_DB_REP_STAT_ST_BULK_TRANSFERS 0
#define HAVE_ST_DB_REP_STAT_ST_CLIENT_REREQUESTS 0
#define HAVE_ST_DB_REP_STAT_ST_CLIENT_SVC_MISS 0
#define HAVE_ST_DB_REP_STAT_ST_CLIENT_SVC_REQ 0
#define HAVE_ST_DB_REP_STAT_ST_EGEN 0
#define HAVE_ST_DB_REP_STAT_ST_ELECTION_NVOTES 0
#define HAVE_ST_DB_REP_STAT_ST_ELECTION_SEC 0
#define HAVE_ST_DB_REP_STAT_ST_ELECTION_USEC 0
#define HAVE_ST_DB_REP_STAT_ST_NEXT_PG 0
#define HAVE_ST_DB_REP_STAT_ST_PG_DUPLICATED 0
#define HAVE_ST_DB_REP_STAT_ST_PG_RECORDS 0
#define HAVE_ST_DB_REP_STAT_ST_PG_REQUESTED 0
#define HAVE_ST_DB_REP_STAT_ST_STARTUP_COMPLETE 0
#define HAVE_ST_DB_REP_STAT_ST_WAITING_PG 0
#define HAVE_ST_DBC_CLOSE 0
#define HAVE_ST_DBC_COUNT 0
#define HAVE_ST_DBC_DEL 0
#define HAVE_ST_DBC_DUP 0
#define HAVE_ST_DBC_GET 0
#define HAVE_ST_DBC_PGET 0
#define HAVE_ST_DBC_PUT 0
#define HAVE_ST_DBC_GET_PRIORITY 0
#define HAVE_ST_DB_SET_H_COMPARE 0
#define HAVE_ST_DB_SET_Q_EXTENDSIZE 0
#define HAVE_ST_DB_SET_PRIORITY 0
#define HAVE_ST_DB_BYTESWAPPED 0
#define HAVE_ST_DB_SET_CACHE_PRIORITY 0
#define HAVE_DB_OPEN_7_DB_CREATE 0
#define HAVE_DB_KEY_DBT_MALLOC 0
#define HAVE_ST_DB_ENV_GET_REP_NSITES 0
#define HAVE_ST_DB_ENV_REP_GET_NSITES 0
#define HAVE_ST_DB_ENV_REP_GET_PRIORITY 0
#define HAVE_ST_DB_ENV_LG_INFO 0
#define HAVE_ST_DB_ENV_SET_TXN_TIMEOUT 0
#define HAVE_ST_DB_ENV_SET_LOCK_TIMEOUT 0
#define HAVE_ST_DB_ENV_REP_SET_LIMIT 0
#define HAVE_ST_DB_ENV_SET_MSGCALL 0
#define HAVE_ST_DB_ENV_SET_THREAD_ID 0
#define HAVE_ST_DB_ENV_SET_THREAD_ID_STRING 0
#define HAVE_ST_DB_ENV_SET_ISALIVE 0
#define HAVE_ST_DB_ENV_REP_SET_NSITES 0
#define HAVE_ST_DB_ENV_REP_SET_PRIORITY 0
#define HAVE_ST_DB_ENV_REP_SET_CONFIG 0
#define HAVE_ST_DB_ENV_REP_SET_TIMEOUT 0
#define HAVE_ST_DB_ENV_REP_SET_TRANSPORT 0
#define HAVE_ST_DB_ENV_REPMGR_SET_LOCAL_SITE 0
#define HAVE_ST_DB_ENV_REPMGR_ADD_REMOTE_SITE 0
#define HAVE_ST_DB_ENV_REPMGR_SET_ACK_POLICY 0
#define HAVE_ST_DB_ENV_REPMGR_SET_SITE_LIST 0
#define HAVE_ST_DB_ENV_REPMGR_START 0
#define HAVE_ST_DB_ENV_SET_INTERMEDIATE_DIR_MODE 0
#define HAVE_ST_DB_ENV_SET_EVENT_NOTIFY 0
...
#define HAVE_ST_DB_ENV_LSN_RESET 0
#define HAVE_ST_DB_ENV_FILEID_RESET 0
#define HAVE_ST_DB_ENV_FAILCHK 0
#define HAVE_ST_DB_ENV_REP_SYNC 0
...
#define HAVE_DB_ENV_ERRCALL_3 0
...
#define HAVE_DB_ENV_REP_ELECT_4 0
...
#define HAVE_ST_DB_BTREE_STAT_BT_PAGECNT 0
#define HAVE_DB_STAT_4 0
#define HAVE_ST_DB_ENV_LK_INFO 0
#define HAVE_ST_DB_LOCK_STAT_ST_LASTID 0
#define HAVE_ST_DB_LOCK_STAT_ST_LOCK_NOWAIT 0
#define HAVE_ST_DB_LOCK_STAT_ST_LOCK_WAIT 0
#define HAVE_ST_DB_LOCK_STAT_ST_OBJS_NOWAIT 0
#define HAVE_ST_DB_LOCK_STAT_ST_OBJS_WAIT 0
#define HAVE_ST_DB_LOCK_STAT_ST_LOCKERS_NOWAIT 0
#define HAVE_ST_DB_LOCK_STAT_ST_LOCKERS_WAIT 0
#define HAVE_ST_DB_LOCK_STAT_ST_LOCKS_NOWAIT 0
#define HAVE_ST_DB_LOCK_STAT_ST_LOCKS_WAIT 0
#define HAVE_ST_DB_TXN_SET_NAME 0
#define HAVE_ST_DB_ENV_TX_INFO 0
#define HAVE_ST_DB_TXN_STAT_ST_PENDING_CKP 0
#define HAVE_ST_DB_TXN_ACTIVE_TID 0
#define HAVE_ST_DB_TXN_ACTIVE_NAME 0
#define HAVE_TXN_RECOVER 0
#define HAVE_ENV_REP_TRANSPORT_6 0
#define HAVE_DB_ENV_REP_ELECT_PRIO 0
#define HAVE_DB_ENV_REP_PROCESS_MESSAGE_ENVID 0
