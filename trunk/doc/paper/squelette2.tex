...
\par Le système NLGbAse.QR\footnote{http://sit.vickev.fr/semantic-ruby/www/} est peut être expérimenté en ligne, et le corpus de test que nous avons utilisé sera très certainement mis à disposition sur le site de NLGbAse.
